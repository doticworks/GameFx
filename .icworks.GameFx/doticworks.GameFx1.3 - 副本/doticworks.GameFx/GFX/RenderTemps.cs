...
namespace doticworks.GameFx.GFX
{
	...
	{
		int _w;int _h;
		RawMatrix3x2 temp_tran=new RawMatrix3x2(0,0,0,0,0,0);
...
//		void Set_temp_Geo(Action<GeoPainter> adds,float R,float G,float B,float A){
//			PathGeometry pa;
//			GeometrySink gs=pa.Open();
//			InkBezierSegment i=new InkBezierSegment();
//			QuadraticBezierSegment q=new QuadraticBezierSegment();
//			
//			BezierSegment bd=new BezierSegment();
//			_rt.DrawGeometry(pa,temp_brush_solid);
//			
//		}
